...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"fish-utils"' -DVERSION='"0.1.3"' -I'./shared' -I'./extern' -isystem'extern/codegen/include' -save-temps=obj
